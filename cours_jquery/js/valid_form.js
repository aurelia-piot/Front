$(function () {
    ...
    $('#contact').submit(function (e) {
        ...
        if (prenom.val().length === 0) {
            //0= false =donc vide = donc invalide
...
// Si dans le document , une balise a la class=" is-invalid", si le formulaire ne comporte pas de champ vide
        if ($(this).find('.is-invalid').length === 0) {
                //alors on remplace le form (this) par la div .alert-success
            $(this).replaceWith(
            ...
            //SINON on créer avant le form (this) la div .alert-danger
